<?php /* Smarty version 2.6.18, created on 2010-04-16 04:38:12
...
<tr>
<td class="findtitle"><?php if (empty ( $this->_tpl_vars['what'] )): ?>Find<?php else: ?><?php $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;smarty_block_tr($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo $this->_tpl_vars['what']; ?>
...
" />
	<?php if (isset ( $this->_tpl_vars['exact_match'] )): ?>Exact&nbsp;match<input type="checkbox" name="exact_match" <?php if ($this->_tpl_vars['exact_match'] != 'n'): ?>checked="checked"<?php endif; ?>/><?php endif; ?>
</td>

<?php if (! empty ( $this->_tpl_vars['types'] )): ?>
	<td class="findtitle">
		<select name="type">
		<option value='' <?php if ($this->_tpl_vars['find_type'] == ''): ?>selected="selected"<?php endif; ?>>any type</option>
...
<?php if (! empty ( $this->_tpl_vars['topics'] )): ?>
	<td class="findtitle">
		<select name="topic">
		<option value='' <?php if ($this->_tpl_vars['find_topic'] == ''): ?>selected="selected"<?php endif; ?>>all topic</option>
...
<?php if ($this->_tpl_vars['feature_multilingual'] == 'y'): ?>
	<td class="findtitle">
		<select name="lang">
		<option value='' <?php if ($this->_tpl_vars['find_lang'] == ''): ?>selected="selected"<?php endif; ?>>any language</option>
		<?php unset($this->_sections['ix']);
$this->_sections['ix']['name'] = 'ix';
...
<?php if ($this->_tpl_vars['feature_categories'] == 'y'): ?>
	<td class="findtitle">
		<select name="categId">
		<option value='' <?php if ($this->_tpl_vars['find_categId'] == ''): ?>selected="selected"<?php endif; ?>>any category</option>
		<?php unset($this->_sections['ix']);
$this->_sections['ix']['name'] = 'ix';
...
<td class="findtitle"><input type="submit" name="search" value="find" /></td>
</tr>
</table>
