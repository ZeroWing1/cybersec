...
smarty_core_load_plugins(array('plugins' => array(array('function', 'elapsed', 'tiki-bot_bar.tpl', 66, false),array('function', 'memusage', 'tiki-bot_bar.tpl', 66, false),)), $this); ?>
...
<div id="loadstats" style="text-align: center">
 ...
 ] &nbsp; [ GZIP <?php echo $this->_tpl_vars['gzip']; ?>
...
<?php endif; ?>
	...
	<div id="power" style="text-align: center">
		Powered by <a target="_blank" href="http://tikiwiki.org" title="This is TikiWiki CMS/Groupware <?php echo $this->_tpl_vars['tiki_version']; ?>
 -<?php echo $this->_tpl_vars['tiki_star']; ?>
- &#169; 2002&#8211;2008, Tikiwiki developers">Tikiwiki CMS/Groupware</a>
	</div>