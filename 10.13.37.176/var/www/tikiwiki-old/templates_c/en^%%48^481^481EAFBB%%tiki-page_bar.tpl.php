...
" href="tiki-editpage.php?page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
<?php if ($this->_tpl_vars['page_ref_id']): ?>&amp;page_ref_id=<?php echo $this->_tpl_vars['page_ref_id']; ?>
<?php endif; ?>" class="linkbut">
...
<?php else: ?>
    <?php if ($this->_tpl_vars['feature_history'] == 'y' && $this->_tpl_vars['tiki_p_wiki_view_history'] == 'y' && ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)) != 'sandbox'): ?>
    <td>
      <div class="button2" >
...
<?php endif; ?>
<?php if ($this->_tpl_vars['tiki_p_rename'] == 'y' && $this->_tpl_vars['editable']): ?>
...
<?php if ($this->_tpl_vars['feature_likePages'] == 'y' && ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)) != 'sandbox'): ?>
...
<?php endif; ?>
<?php if ($this->_tpl_vars['feature_wiki_undo'] == 'y' && $this->_tpl_vars['canundo'] == 'y' && ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)) != 'sandbox'): ?>
<td><div class="button2"><a href="tiki-index.php?page=<?php echo ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
&amp;undo=1" class="linkbut">undo</a></div></td>
<?php endif; ?>
<?php if ($this->_tpl_vars['wiki_uses_slides'] == 'y'): ?>
<?php if ($this->_tpl_vars['show_slideshow'] == 'y'): ?>
...
<?php endif; ?>
<?php endif; ?>
<?php if ($this->_tpl_vars['feature_wiki_export'] == 'y' && $this->_tpl_vars['tiki_p_admin_wiki'] == 'y' && ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)) != 'sandbox'): ?>
...
<?php endif; ?>
<?php if ($this->_tpl_vars['feature_wiki_discuss'] == 'y'): ?>
...
<?php if ($this->_tpl_vars['show_page'] == 'y'): ?> 
  ...
  <?php if ($this->_tpl_vars['feature_wiki_comments'] == 'y' && ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)) != 'sandbox' && $this->_tpl_vars['tiki_p_wiki_view_comments'] == 'y' && ( ( $this->_tpl_vars['tiki_p_read_comments'] == 'y' && $this->_tpl_vars['comments_cant'] != 0 ) || $this->_tpl_vars['tiki_p_post_comments'] == 'y' || $this->_tpl_vars['tiki_p_edit_comments'] == 'y' )): ?>
   <td>
    <div class="button2">
...
&amp;comzone=hide<?php endif; ?>" onclick="javascript:flip('comzone<?php if ($this->_tpl_vars['comments_show'] == 'y'): ?>open<?php endif; ?>');<?php if ($this->_tpl_vars['comments_show'] == 'y'): ?> return false;<?php endif; ?>"
  ...
  <td>
    <div class="button2">
      <a href="#attachments" onclick="javascript:flip('attzone');" class="linkbut">
        ...
        <?php else: ?>
          <span class="highlight"><?php $this->_tag_stack[] = array('tr', array()); $_block_repeat=true;smarty_block_tr($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo $this->_tpl_vars['atts_cnt']; ?>
 files attached<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_tr($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span>
  ...
  <?php if ($this->_tpl_vars['feature_multilingual'] == 'y' && $this->_tpl_vars['tiki_p_edit'] == 'y' && ! $this->_tpl_vars['lock'] && ((is_array($_tmp=$this->_tpl_vars['page'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)) != 'sandbox'): ?>
...
<?php if ($this->_tpl_vars['wiki_extras'] == 'y' && $this->_tpl_vars['feature_wiki_attachments'] == 'y' && $this->_tpl_vars['tiki_p_wiki_view_attachments'] == 'y'): ?>
...
<?php if ($this->_tpl_vars['feature_wiki_comments'] == 'y' && $this->_tpl_vars['tiki_p_wiki_view_comments'] == 'y'): ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
