<?php /* Smarty version 2.6.18, created on 2010-04-16 04:38:40
...
<tr>
  ...
  <div class="simplebox">
  <table>
  <tr><td class="form">User:</td><td><?php echo $this->_tpl_vars['userinfo']['login']; ?>
...
<?php if ($this->_tpl_vars['feature_score'] == 'y'): ?>
  <tr><td class="form">Score:</td><td><?php echo ((is_array($_tmp=$this->_tpl_vars['userinfo']['score'])) ? $this->_run_mod_handler('star', true, $_tmp) : smarty_modifier_star($_tmp)); ?>
