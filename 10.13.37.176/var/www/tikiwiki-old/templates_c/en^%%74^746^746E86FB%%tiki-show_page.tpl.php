...
<?php if ($this->_tpl_vars['feature_page_title'] == 'y'): ?>
...
"><img src="img/icons/ico_print.gif" border="0"  width="16" height="16" alt="print" /></a>
	...
	<?php if ($this->_tpl_vars['feature_wiki_pdf'] == 'y'): ?>
		<a title="create PDF" href="tiki-config_pdf.php?<?php if ($this->_tpl_vars['home_info'] && $this->_tpl_vars['home_info']['page_ref_id']): ?>page_ref_id=<?php echo $this->_tpl_vars['home_info']['page_ref_id']; ?>
...
<?php endif; ?>"><img src="img/icons/ico_pdf.gif" border="0"  width="16" height="16" alt="PDF" /></a>
	<?php endif; ?>
