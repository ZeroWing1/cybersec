...
<?php $this->_tag_stack[] = array('tikimodule', array('title' => $this->_tpl_vars['user_title'],'name' => $this->_tpl_vars['user_module_name'],'flip' => $this->_tpl_vars['module_params']['flip'],'decorations' => $this->_tpl_vars['module_params']['decorations'],'overflow' => $this->_tpl_vars['module_params']['overflow'])); $_block_repeat=true;smarty_block_tikimodule($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
