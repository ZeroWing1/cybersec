...
"You must provide a project name" => "Você precisa dar um nome ao projeto",
"You must provide a project description" => "Você precisa criar uma descrição para o projeto",
...
"someone coming from IP Address" => "alguém vindo do endereço de IP",
"requested a reset of the password for the" => "pediu para restaurar a sua senha para o",
...
"This is only a temporary password. After you logged in with it, you will get to the 'change password' dialog." => "Essa é apenas uma senha temporária. Depois que você logar no sistema com ela será necessário criar uma nova senha.",
...
"Image options: xListSize,yListSize,xDetailsSize,yDetailsSize indicated in pixels." => "Opções da imagem: xTamLista,yTamLista,xTamDetalhes,yTamDetalhes indicados em pixels.",
...
"Jukebox preference" => "Preferências do jukebox",
...
"Anguilla" => "Anguila",
"Albania" => "Albânia",
"Netherlands_Antilles" => "Antilhas_Holandesas",
"Aruba" => "Aruba",
// "Aland_Islands" => "Aland_Islands",
"Azerbaijan" => "Azerbaijão",
"Bosnia_and_Herzegovina" => "Bósnia_e_Herzegóvina",
...
"Botswana" => "Botsuana",
"Belize" => "Belize",
"Catalan_Countries" => "Países_Catalãos",
// "Cocos_Islands" => "Cocos_Islands",
"Central_African_Republic" => "República_Centro_Africana",
"Congo_Democratic" => "República_Democrática_do_Congo",
"Cape_Verde" => "Cabo_Verde",
// "Christmas_Island" => "Christmas_Island",
"Djibouti" => "Djibouti",
"Dominica" => "Dominicana",
"Western_Sahara" => "Saara do Oeste",
"Eritrea" => "Eritréia",
"Falkland_Islands" => "Ilhas_Marianas",
...
// "Equatorial_Guinea" => "Guiné_Equatorial",
...
"Jersey" => "Jérsei",
"Kyrgyzstan" => "Quirjistão",
"Cambodia" => "Cambodja",
"Comoros" => "Comoros",
// "Saint_Kitts_and_Nevis" => "Saint_Kitts_and_Nevis",
"Laos" => "Laos",
"Saint_Lucia" => "Santa_Lúcia",
...
"Sierra_Leone" => "Serra_Leoa",
"San_Marino" => "San_Marino",
"Senegal" => "Senegal",
"Sao_Tome_and_Principe" => "São_Tomé_e_Príncipe",
"Syria" => "Síria",
// "Swaziland" => "Swaziland",
...
"Togo" => "Togo",
"Tajikistan" => "Tajikistão",
"Tokelau" => "Tokelau",
"Turkmenistan" => "Turcomenistão",
"Tanzania" => "Tanzânia",
"Uganda" => "Uganda",
// "United_States_Minor_Outlying_Islands" => "Estados_Unidos_Minor_Outlying_Islands",
...
"Galician" => "Galego",
"index" => "índice",
"Textarea options: quicktags,width,height,max,listmax - Use Quicktags is 1 or 0, widthis indicated in chars, height is indicated in lines, max is the maximum number of characters that can be saved, listmax isthe maximum number of characters that are displayed in list mode." => "Opções da área de texto: quicktags,tamanho,altura,max,listmax - Use Quicktags 1 ou 0, o tamanho é indicado em caracteres, a altura é indicada por linhas, max é o número máximo de caracteres que podem ser salvos, listmax é o número máximo de caracteres a serem mostrados no modo lista.",
"Default value is specified by having the value indicated twice consecutively" => "O valor padrão é especificado ao indicar o valor consecutivamente duas vezes.",
// "drop down with other textfield" => "drop down with other textfield",
"Image options: xListSize,yListSize,xDetailsSize,yDetailsSize,uploadLimitScale indicated in pixels." => "Opções de Imagem: xListSize,yListSize,xDetailsSize,yDetailsSize,uploadLimitScale indicated em pixels.",
"Item Link options: trackerId,fieldId,linkToItem links to item from trackerId which fieldId matches the content of that field. linkToItem 1|0 to create a link to the item in view mode and listing" => "Opções de Link de Item: trackerId,fieldId,linkToItem links de ítem para trackerId onde fieldId  corresponde ao conteúdo daquele campo. linkToItem 1|0 para criar um link para o ítem no modo de visualização ou de listagem",
...
"The registration mail can't be sent because there is no server email address set, and this feature is disabled" => "O registro não pode ser enviado por que não há servidor de e-mail configurado, e esse recurso está indisponível",
"~np~{~/np~EVENTS(calendarid=>id1+id2,maxdays=>365,max=>-1,datetime=>0|1,desc=>0|1)}{EVENTS} Insert rss feed output into a wikipage" => "~np~{~/np~EVENTS(calendarid=>id1+id2,maxdays=>365,max=>-1,datetime=>0|1,desc=>0|1)}{EVENTS} Insere saída de rss feed em uma página wiki (wikipage)",
"Formula" => "Fórmula",
"No formula specified." => "Sem fórmula especificada.",
"Displays text in superscript." => "Mostra o texto em sobrescrito.",
"Other:" => "Outro:",
"tracker field type not processed yet" => "campo de acompanhamento digitado ainda não foi processado",
"incorrect filterfield" => "campo de filtro incorreto",
"Page-Pattern" => "Página-Padrão",
...
"(refer to PHP function fnmatch() for details)\n" => "(refere-se a função do PHP fnmatch() para detalhes)\n",
...
"WikiWord" => "PalavraWiki",
// "not in level" => "not in level",
"Referenced By Page" => "Referenciado pela página",
"Threaded" => "Encadeado",
...
"TikiWiki Assistant" => "Assistente do TikiWiki",
"Thank you for installing TikiWiki CMS/Groupware" => "Obrigado por instalar o TikiWiki CMS/Groupware",
"To configure your Tiki" => "Para configurar seu Tiki",
"Admin Home" => "Página de administração",
"from the menu" => "a partir do menu",
"Read the <a class=\"link\" href=\"http://doc.tikiwiki.org/Configuration\" title=\"TikiWiki Documentation\" target=\"_blank\">configuration documentation</a>" => "Leia a <a class=\"link\" href=\"http://doc.tikiwiki.org/Configuration\" title=\"TikiWiki Documentation\" target=\"_blank\">documentação sobre configuração</a>",
"Watch the <a class=\"link\" href=\"http://tikiwiki.org/TikiMovies\" title=\"Demos\" target=\"_blank\">demo movies" => "Assista os vídeos <a class=\"link\" href=\"http://tikiwiki.org/TikiMovies\" title=\"Demos\" target=\"_blank\">vídeos tutoriais",
"To remove this module" => "Para remover esse módulo",
"and remove the assistant module" => "e remover o módulo de ajuda",
"You can also add other modules" => "Você também pode adicionar outros módulos",
"To customize the menu" => "Para customizar o menu",
"and edit menu ID 42" => "e edite o menu ID 42",
"Or, create your own menu and add it to a module" => "Ou, crie o seu menu e adicione ele à um módulo",
"To begin configuring Tiki, please" => "Para começar a configurar o Tiki, por favor",
"as the Admin" => "como Admin",
...
"For help, visit <a href=\"http://doc.tikiwiki.org\" title=\"TikiWiki Documentation\" target=\"_blank\">http://doc.tikiwiki.org</a>" => "Para ajuda, visite <a href=\"http://doc.tikiwiki.org\" title=\"TikiWiki Documentation\" target=\"_blank\">http://doc.tikiwiki.org</a>",
// "RSS Feeds" => "RSS Feeds",
// "Top `\$module_rows` Objects" => "Top `\$module_rows` Objects",
"Upcoming `\$module_rows` events" => "Próximos `\$module_rows` eventos",
"created by" => "criado por",
"RSS Trackers" => "Acompanhamento RSS",
"Your message has been queued for approval, the message will be posted after\r\na moderator approves it." => "Sua mensagem entrou na fila para aprovação, a mensagem será liberada depois\r\nque uma moderador aprová-la.",
"Intertiki" => "Intertiki",
"InterTiki" => "InterTiki",
// "Trackbacks Pings" => "Trackbacks Pings",
// "Post level trackback pings" => "Post level trackback pings",
"Google Maps" => "Mapas do Google",
"Please expect not found help-pages with the default-URL." => "Ao usar a URL-padrão é esperado que páginas de ajuda não sejam encontradas.",
"Release check" => "Verificar novas versões",
"Check frequency" => "Frequência",
"Each day" => "Diária",
"Each week" => "Semanal",
"Each month" => "Mensal",
"Release checks are made when you browse admin main page only" => "A verificação de uma nova versão é realizada apenas quando você acessa a página principal do painel de administração",
"Force immediate check" => "Forçar verificação imediata",
"Default x for map center" => "Padrão x para o centro do mapa",
"Default y from map center" => "Padrão y a partir do centro do mapa",
"Default zoom level" => "Nível padrão do zoom",
"whole earth" => "a terra inteira",
"country size" => "tamanho do país",
"city size" => "tamanho da cidade",
"max zoom" => "zoom máximo",
"Best Language" => "Idioma preferido",
"Intertiki exchange feature" => "Recurso de troca Intertiki",
"Intertiki client" => "Cliente Intertiki",
"Tiki Unique key" => "Chave Única Tiki",
"InterTiki Slave mode" => "InterTiki em modo Escravo",
" as master" => " como mestre",
"Limit group import (comma-separated list of imported groups, leave empty to avoid limitation)" => "Limitar importação de grupo (lista de grupos importados separada por vígula, deixe vazio para evitar limitação)",
"InterTiki Server" => "Servidor InterTiki",
"Intertiki server" => "Servidor Intertiki",
"Intertiki Server enabled" => "Servidor Intertiki habilitado",
"Access Log file" => "Arquivo Log de acesso",
"Errors Log file" => "Arquivo Log de erros",
"Known hosts" => "Hosts conhecidos",
"Users can opt-out internal messages" => "Usuários podem optar por não participar de mensagens internas",
"Auth Type" => "Tipo de Autenticação",
"IMAP/POP3/LDAP Host" => "Host IMAP/POP3/LDAP",
"IMAP/POP3/LDAP Port" => "Porta IMAP/POP3/LDAP",
"IMAP/POP3 BaseDSN" => "DSN base IMAP/POP3",
"You also need to upload the <a target=\"_blank\" href=\"http://esup-phpcas.sourceforge.net/\">phpCAS library</a> separately to lib/phpcas/." => "Você também precisa fazer a instalação manual da biblioteca <a target=\"_blank\" href=\"http://esup-phpcas.sourceforge.net/\">phpCAS</a> no diretório lib/phpcas/.",
"Configure InterTiki here" => "Configure o InterTiki aqui",
// "Right &amp; left boxes" => "Right &amp; left boxes",
"Feed for individual tracker items" => "Feed para cada item de um acompanhamento",
"Feed for upcoming calendar events" => "Feed para os próximos eventos do calendário",
...
"Refresh trackers search index now" => "Atualizar busca de acompanhamentos agora",
"Refresh tracker search index now" => "Atualizar busca de acompanhamentos agora",
// "LRU list purging rate" => "LRU list purging rate",
"Here you can (as an admin) place a piece of custom XHTML and/or Smarty code. Be careful and properly close all the tags before you choose to publish ! (Javascript, applets and object tags are stripped out.)" => "Aqui você pode (como administrador) colocar um código de XHTML e/ou Smarty personalizado. Tome cuidado e apropriadamente feche todas as tags antes de publicar ! (Tags do tipo Javascript, Applets e Object tags não são permitidos.)",
// "Prefix breadcrumbs with 'Location:' label?" => "Prefix breadcrumbs with 'Location:' label?",
"Test" => "Teste",
"Text area (that apply throughout many features)" => "Área de texto (que se aplica em todos os recursos)",
...
"Categories path" => "Caminho para as categorias",
"Load page on navigation" => "Carregar página ao navegar",
"Camera distance" => "Distância da câmera",
"Camera distance adjusted relative to nearest node" => "Distância da câmera ajustada relativamente ao nó mais próximo",
// "Field of view" => "Field of view",
"Node size" => "Tamanho do nó",
"Text size" => "Tamanho do texto",
// "Friction constant" => "Friction constant",
"Elastic constant" => "Constante Elástica",
"Eletrostatic constant" => "Constante Eletrostática",
// "Spring (connection) size" => "Spring (connection) size",
// "Node mass" => "Node mass",
// "Node charge" => "Node charge",
"History only for data, description, comment change" => "Histório apenas para o conteúdo, descrição e comentários",
"A new version of TikiWiki, <b>{\$tiki_release}</b>, is available. You are currently running <b>{\$tiki_version}</b>. Please visit <a href=\"http://tikiwiki.org/Download\">http://tikiwiki.org/Download</a>." => "Uma nova versão do TikiWiki, <b>{\$tiki_release}</b>, está disponível. Atualmente você You are currently running <b>{\$tiki_version}</b>. Please visit <a href=\"http://tikiwiki.org/Download\">http://tikiwiki.org/Download</a>.",
"Spreadsheet" => "Planilha",
"Mods" => "Modificações",
"Click and scroll up to the top of the page" => "Clique e role para o começo da página",
// "Stats &amp; banners" => "Stats &amp; banners",
// "perso" => "perso",
// "Current Category ID:" => "ID da Categoria atual:",
// "admin charts template" => "admin charts template",
"Managing content templates" => "Gerenciando conteúdo dos templates",
...
// "mn" => "mn",
"This will work well (or not!) depending on your theme. To learn more about <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://themes.tikiwiki.org\">themes</a>" => "Isso funcionará bem (ou não!) dependendo do seu tema. Para aprender mais sobre temas <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://themes.tikiwiki.org\">temas</a>",
// "\n<b>Note 1</b>: if you allow your users to configure modules then assigned\nmodules won't be reflected in the screen until you configure them\nfrom MyTiki->modules.<br />\n<b>Note 2</b>: If you assign modules to groups make sure that you\nhave turned off the option 'display modules to all groups always'\nfrom <a href=\"tiki-admin.php?page=module\">Admin->Modules</a>\n" => "\n<b>Note 1</b>: if you allow your users to configure modules then assigned\nmodules won't be reflected in the screen until you configure them\nfrom MyTiki->modules.<br />\n<b>Note 2</b>: If you assign modules to groups make sure that you\nhave turned off the option 'display modules to all groups always'\nfrom <a href=\"tiki-admin.php?page=module\">Admin->Modules</a>\n",
"vertical" => "vertical",
"Admin calendar" => "Administrar Calendário",
"Show in popup box" => "Mostrar em janela popup",
...
"Show tracker ID" => "Mostrar ID de acompanhamento",
// "with leading zeroes?" => "with leading zeroes?",
"hyphenated?" => "Usar hífem?",
...
"Show creation date when viewing tracker item?" => "Mostrar data de criação quando visualizar item de acompanhamento?",
"Show lastModif date when viewing tracker item?" => "Mostras data da última modificação quando visualizar item de acompanhamento?",
...
"Download CSV export" => "Carregar CSV exportado",
"tracker_{\$trackerId}.csv" => "acompanhamento_{\$trackerId}.csv",
...
"Help for Backups" => "Ajuda com Backups",
...
"Tikiwiki developers" => "Desenvolvedores Tikiwiki",
...
"Forum Importer" => "Imporatador de Fórum",
"List Forums" => "Listar Fóruns",
"Import from a Local SQL File" => "Importar um arquivo SQL local",
...
"<b>File must be an SQL file and exist in either <i>\$tikiroot/temp</i> or <i>\$tikiroot/img/wiki_up</i>.</b>" => "<b>O arquivo precisa ser um arquivo SQL e estar disponível em <i>\$tikiroot/temp</i> ou <i>\$tikiroot/img/wiki_up</i>.</b>",
"File was not specified, or could not be found in either location. Please put the file in either directory and Go Back. If the file exists in both locations, the \$tikiroot/{\$filecheck} location will be preferred." => "A localização do arquivo não foi especificada ou não foi possível localizá-lo. Por favor coloque o arquivo num dos diretórios especificados e tente novamente. Se o arquivo estiver disponível nos dois diretórios, o que está em \$tikiroot/{\$filecheck} será utilizado.",
"Select a Forum You Wish to Move (ONE at a time!)" => "Selecione um fórum que você deseja mover (um por vez!)",
...
"You need to set a <a href=\"tiki-admin.php?page=gmap\">Google Maps API key</a>" => "Você precisa definir a <a href=\"tiki-admin.php?page=gmap\">chave para a API de mapas do Google</a>",
...
"Descriptions of the \navailable profiles" => "Descrição dos \nperfis disponíveis",
"For database update from 1.8 or later" => "Para atualização do banco de dados da versão 1.8 ou mais nova",
"If you upgrade from 1.8.x you <b>MUST</b> run tiki_1.8to1.9 and don't need an additional script" => "Se você está atualizando a partir da versão 1.8.x você <b>DEVE</b> executar tiki_1.8to1.9 e não necessita de outro script adicional",
"If you upgrade from a previous 1.9.x version, use tiki_1.8to1.9, too. (ex.: 1.9.2 to 1.9.5)" => "Se você está atualizando a partir da versão 1.9.x, também use o tiki_1.8to1.9. (exemplo: 1.9.2 para 1.9.5)",
"For database update from 1.7.x, please visit <a target=\"help\" href=\"http://doc.tikiwiki.org/Upgrade+1.7+to+1.8\">Tiki database 1.7.x to 1.8x instructions" => "Para atualizar a partir da versão 1.7.x, veja a página <a target=\"help\" href=\"http://doc.tikiwiki.org/Upgrade+1.7+to+1.8\">Tiki database 1.7.x to 1.8x instructions",
"For information about tiki-secdb_*.sql files, please see <a target=\"help\" \nhref=\"http://doc.tikiwiki.org/Security+Admin\">http://doc.tikiwiki.org/Security+Admin" => "Para informações sobre os arquivos tiki-secdb_*.sql, veja <a target=\"help\" \nhref=\"http://doc.tikiwiki.org/Security+Admin\">http://doc.tikiwiki.org/Security+Admin",
"sql queries have successfully been executed." => "as instruções sql foram executadas com sucesso.",
"Make sure tiki gets more than 8 MB of memory for script execution. \nSee file php.ini, the relevant key is memory_limit. Use something like memory_limit = 16M and restart your \nwebserver. Too little memory will cause blank pages!" => "Verifique se o Tiki possui mais de 8 MB de memória para executar scripts. \nVerifique o parâmetro memory_limit no arquivo php.ini. Utilize no mínimo memory_limit = 16M e reinicie seu \nservidor web. Memória de menos pode produzir erros inesperados, como páginas em branco!",
"Tiki has not detected your PHP memory_limit. This probably means you have no set limit (all is well)" => "Não foi possível detectar o valor do memory_limit do PHP. Provavelmente isso significa que o valor não está definido, o que não representa um problema",
"Tiki has detected your PHP memory limit at only 8 Megs" => "O Tiki detectou que o memory_limit do PHP está configurado para apenas 8MB",
"Tiki has detected your PHP memory_limit at" => "Tiki detectou que o memory_limit do PHP está configurado para",
"If you did a Tiki upgrade, make sure to clean the caches (templates_c/) manually or by using the feature on admin / system" => "Se você fez a atualização de uma versão anterior do Tiki, limpe o cache (templates_c/) manualmente ou utilizando a página tiki-admin_system.php",
"Now you may proceed by clicking one of these links" => "Agora, prossiga clicando em um desses links",
"Click here to disable the install script and proceed into tiki" => "Clique aqui para desabilitar o script de instalação e entrar no Tiki",
"Click here to proceed into tiki without disabling the script" => "Clique aqui para entrar no Tiki sem desabilitar o script de instalação",
"Go back and run another install/upgrade script" => "Retorne e rode outro script de instalação/atualização",
"do not use your Back button in your browser!" => "não use o botão Voltar do seu navegador!",
"To use a banner in a <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">module</a> or a template, use {literal}{banner zone=ABC}{/literal}, where ABC is the name of the zone." => "Para utilizar um banner em um <a class=\"rbox-link\" href=\"tiki-admin_modules.php\">módulo</a> ou template, utilize {literal}{banner zone=ABC}{/literal}, onde ABC é o nome da zona de banners.",
"Help for managing cache" => "Ajuda para gerenciamento de cache",
...
"How to Use FAQs" => "Como usar as FAQs",
"Flash binary (.swf or .dcr)" => "Flash binário (.swf ou .dcr)",
"Blog Help" => "Ajuda do Blog",
"Trackers Help" => "Ajuda dos acompanhamentos",
"offline" => "offline",
"To learn more about <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://mods.tikiwiki.org\">mods</a>." => "Para mais informações sobre <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://mods.tikiwiki.org\">mods</a>.",
"Tikiwiki Mods" => "Modificações do Tikiwiki",
"Mods Configuration" => "Configuração das Modificações",
"Update remote index" => "Atualizar índice remoto",
"Tikiwiki Mods Configuration" => "Configuração das Modificações do Tikiwiki",
"Mods Install/uninstall" => "Instalar/desinstalar Modificações",
// "Enable Mods providing" => "Enable Mods providing",
"Mods local directory" => "Diretório local das Modificações",
"Mods remote server" => "Servidor remoto das Modificações",
...
"Add Pages from Structures" => "Adicionar Páginas das Estruturas",
"No structures" => "Sem estruturas",
...
"Graph" => "Gráfico",
"Clean logs older than" => "Limpar logs mais velhos que",
"months" => "meses",
"clean" => "limpar",
"To learn more about <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://themes.tikiwiki.org\">themes</a>." => "Para aprender mais sobre <a class=\"rbox-link\" target=\"tikihelp\" href=\"http://themes.tikiwiki.org\">temas</a>.",
"You can also <a class=\"rbox-link\" href=\"tiki-admin.php?page=theme\">change the default theme</a>." => "Você também pode <a class=\"rbox-link\" href=\"tiki-admin.php?page=theme\">mudar o tema padrão</a>.",
// "theme control objects tpl" => "theme control objects tpl",
// "theme control sections tpl" => "theme control sections tpl",
"You can include the file in an Wiki page using" => "Você pode incluir o arquivo em uma página Wiki usando",
"You can include the file in an HTML page using" => "Você pode incluir o arquivo em uma página HTML usando",
// "Toggle" => "Toggle",
...
"Current version is up to date : <b>%s</b>" => "A versão utilizada é a mais recente : <b>%s</b>",
// "A new major release branch is available." => "A new major release branch is available.",
// "A new major release branch is also available." => "A new major release branch is also available.",
"You can not create a category with a name already existing at this level" => "Você não pode criar uma categoria com um nome já utilizado neste mesmo nível",
"moved %d images, %d errors occured." => "%d imagens foram movidas, %d erros ocorreram.",
...
"Created account %s <%s>." => "Criada conta %s <%s>.",
"New %s created with %s %s (%s)." => "Novo %s criado com %s %s (%s).",
// "Tiki RSS feed for calendars" => "Tiki RSS feed for calendars",
"Site No validated yet" => "Site ainda não validado",
...
"login" => "login",
"Sites" => "Sites",
"Wiki RSS" => "RSS do Wiki ",
"Blogs RSS" => "RSS dos Blogs",
"cache" => "cache",
"del" => "del",
"[-]" => "[-]",
