...
{/if}
	...
	<div id="power" style="text-align: center">
		{tr}Powered by{/tr} <a target="_blank" href="http://tikiwiki.org" title="{tr}This is{/tr} TikiWiki CMS/Groupware {$tiki_version} -{$tiki_star}- &#169; 2002&#8211;2008, {tr}Tikiwiki developers{/tr}">{tr}Tikiwiki CMS/Groupware{/tr}</a>
	</div>
