{* $Id: tiki-plugin_trackerlist.tpl,v 1.9.4.31 2008/04/08 18:46:36 kerrnel22 Exp $ *}
...
{elseif $items[user].field_values[ix].type eq 'F'}
<td class="auto">
{if $items[user].field_values[ix].value}{$items[user].field_values[ix].value|tiki_short_date}{else}&nbsp;{/if}
</td>
