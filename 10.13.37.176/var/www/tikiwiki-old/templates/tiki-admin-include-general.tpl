{* $Header: /cvsroot/tikiwiki/tiki/templates/tiki-admin-include-general.tpl,v 1.35.2.49 2008/04/02 05:19:35 marclaporte Exp $ *}
...
{/if}
        ...
        <td><input type="checkbox" name="session_db" id="general-session_db"
              ...
              {popup text="{tr}Specify if session data will be stored in the database instead of memory. Use this feature to share load between servers. Hint: Only activate this if you know what you are doing. You could be locking yourself out!{/tr}" textcolor=red}
              />
        </td>
      </tr><tr>
