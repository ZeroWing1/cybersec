{* $Id: tiki-view_tracker.tpl,v 1.89.2.94 2008/04/04 16:49:46 kerrnel22 Exp $ *}
...
{if $items[user].field_values[ix].value}{$items[user].field_values[ix].value|tiki_short_date|truncate:255:"..."|default:"&nbsp;"}{else}&nbsp;{/if}
...
{elseif $items[user].field_values[ix].type eq 'F'}
<td class="auto">
{if $items[user].field_values[ix].value}{$items[user].field_values[ix].value|tiki_short_date|default:"&nbsp;"}{else}&nbsp;{/if}
</td>
{elseif $items[user].field_values[ix].type eq 'a'}
<td class="auto">
{if $items[user].field_values[ix].options_array[4] ne ''}
...
{elseif $fields[ix].type eq 'F'}
  {if $cur_field.isMandatory eq 'y'}
    {html_select_date prefix="ins_"|cat:$cur_field.id start_year="-4" end_year="
+4"}

  {else}
    {if $fields[ix].options_array[0] eq '0' && $fields[ix].value eq ''}
      {html_select_date prefix=$fields[ix].ins_id start_year="-4" end_year
="+4" year_empty=" " month_empty=" " day_empty=" " time="--"}
    {else}
      {html_select_date prefix=$fields[ix].ins_id start_year="-4" end_year
="+4" year_empty=" " month_empty=" " day_empty=" " time=$fields[ix].value}
    {/if}
  {/if}
